...
_CANON_LABELS = {
    ...
    # English-taxonomy renderings — some issuers file the SIFIC blocks in English
    # (e.g. Becle 2018-2019: "[310000] Statement of comprehensive income" with
    # "Revenue 19,270,368,000 …"). Same fixed-label contract, translated.
    "revenue": "revenue",
    "cost of sales": "cogs",
    "gross profit": "gross_profit",
    "profit loss from operating activities": "operating_income",
...
def _select(body: str, ncols: int, kind: str, target) -> tuple[int | None, int | None]:
    ...
    header = _header_region(body)
    has_trimestre = "trimestre" in header or "quarter" in header
