...
def _build_source(md_file: Path, period: str, enabled_tiers: set) -> PeriodSource:
    ...
    text = ''
    # The BMV, command-F search, and regex (prose) tiers read the markdown.
    if {'prose', 'bmv', 'search'} & enabled_tiers:
        try:
